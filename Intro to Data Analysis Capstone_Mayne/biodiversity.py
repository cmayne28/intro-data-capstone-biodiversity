...
species['is_protected'] = species.conservation_status.apply(lambda conservation_status: 'True' 	if conservation_status != 'No Intervention'  else 'False')
...
species1 = species.loc[species['is_sheep'] == True]
species1.head()
